...
public class Login_SauceDemo_TestNG {
    ...
    public void testPositiveLoginSauceDemo() throws InterruptedException {
        ...
        Assert.assertTrue(currentUrl.contains("inventory.html"), "Redirect Succes : " + currentUrl);
...
//      WebElement checkBox = driver.findElement(By.className("success-circle"));
//    	checkBox.click();
//		WebElement checkBox = wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("success-circle")));
//		if(!checkBox.isSelected()) {
//			checkBox.click();
//		}
		Thread.sleep(5000);
        ...
        Assert.assertTrue(currentUrl.contains("leetcode"), "Redirect Succes : " + currentUrl);
    }
