...
export default function QuesB2_Main(){
    ...
    function deleteMovie(data){
        setMovie(movie.filter((i)=>i.movieName!==data))
    }

    return (
        <>
            <MovieContext.Provider value={{addMovie : addMovie, movie : movie, deleteMovie : deleteMovie}}>
                <Movies />
                <PrintTable/>
